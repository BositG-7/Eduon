...
const Main: FunctionComponent<MainProps> = () => {
   ...
   return (
      <Box h="150px" maw="100%">
         ...
         <br />
         <br />
         <h1 style={{ color: "blue", margin: "10px 0 0 140px", fontSize: "30px" }}>3. Shartnoma tuzish tartibi</h1>
         <p style={{ margin: "30px 140px", fontSize: "18px" }}>
         ...
         <h2 style={{ color: "black", margin: "10px 0 0 140px" }}>
            <span style={{ color: "blue" }}>4.1. </span> Spikerning majburiyatlari
         </h2>
         <br /> <br />
         <p style={{ margin: "30px 140px", fontSize: "18px" }}>
            Spiker sifatida siz o'zingiz joylashtirgan barcha kontent uchun, shu jumladan ma'ruzalar, viktorinalar, kodlash mashqlari, amaliy
            mashg'ulotlar, topshiriqlar, manbalar, javoblar, kursga kirish sahifasi kontenti va e'lonlari ("Taqdim etilgan kontent") uchun
            javobgarsiz. <br /> <br /> <span style={{ fontWeight: "bolder" }}>Siz quyidagilarni taqdim etasiz va kafolat berasiz:</span> <br /> •Siz
            aniq ma'lumotlarini taqdim etasiz va saqlaysiz; <br /> <br />• Sizning kontentingiz har qanday uchinchi tomonning intellektual mulk
            huquqlarini buzmaydi yoki o'zlashtirmaydi; <br /> <br /> • Siz o'zingizning taqdim etilgan kontentingiz va xizmatlardan foydalanish orqali
            siz taklif qilayotgan xizmatlarni o'rgatish va taklif qilish uchun kerakli malaka, ma'lumot va tajribaga (shu jumladan ta'lim, o'qitish,
            bilim va mahorat to'plamlariga) egasiz; <br /> <br /> • Siz o'zingizning faoliyat sohangiz standartlariga va umuman ko'rsatma xizmatlariga
            mos keladigan xizmat sifatini ta'minlaysiz. <br /> <br />{" "}
            <span style={{ fontWeight: "bolder" }}> Siz shunday qilmasligingizga kafolat berasiz:</span> <br /> <br />
            • Har qanday noo'rin, haqoratli, irqchi, nafratlanuvchi, seksistik, pornografik, yolg'on, chalg'ituvchi, noto'g'ri, yoki tuhmat qilingan
            kontent yoki ma'lumotlarni joylashtirish yoki taqdim etish; <br /> <br /> • Xizmatlar orqali yoki biron bir foydalanuvchiga istalgan yoki
            ruxsatsiz reklama, reklama materiallari, keraksiz pochta xabarlari, spam yoki boshqa iltimosnoma shakllarini (tijorat yoki boshqa)
         ...
         <br />
         <h2 style={{ color: "black", margin: "10px 0 0 140px" }}>
            <span style={{ color: "blue" }}>5.1. </span> Ishonch va xavfsizlik siyosati <br />
         </h2>
         <p style={{ margin: "30px 140px", fontSize: "18px" }}>
         ...
         <h2 style={{ color: "black", margin: "10px 0 0 140px" }}>
            <span style={{ color: "blue" }}>7.3. </span> Pulni qaytarish <br />
         </h2>
         <p style={{ margin: "30px 140px", fontSize: "18px" }}>
            Spikerlar foydalanish shartlari bo'yicha pul mablag'lari qaytarib beriladigan operatsiyalardan daromad olmaydilar.
            <br /> <br />
            Agar talaba biz tegishli spikerning to'lovini to'laganimizdan keyin pulni qaytarib berishni so'rasa, biz (1) o'qituvchiga yuborilgan
            keyingi to'lovdan qaytariladigan summani ushlab qolish huquqiga egamiz yoki (2) qo'shimcha to'lovlar olinmasa, spikerdan to'lovlar
